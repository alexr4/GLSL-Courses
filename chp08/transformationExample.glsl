/**
This example show you how to implement transformation (translate, rotate, scale) on the curve rectangle example
*/
...
void main(){
  ...
  //rotate the fragment from the center
  st = rotate(st, u_time * 0.25);

  //scale the fragment from the center
